...
latexcode=open("proj_latex.tex","w")
...
@@@info@@@
&
 \\includegraphics[width=0.1\\textwidth]{figures/results3/@@@costpng@@@}
      &
     \\includegraphics[width=0.1\\textwidth]{figures/results3/@@@projection1@@@}
      &
              \\includegraphics[width=0.1\\textwidth]{figures/results3/@@@projection2@@@}

           &
               \\includegraphics[width=0.1\\textwidth]{figures/results3/@@@projection3@@@}
        \\\ \hline
'''
