...
# run the program
singularity exec /extra/hossain/gdocker.simg python3 multiview_distance_martix.py cluster3p1 ../dataset_3D/clusters_dataset/dist_1.csv ../dataset_3D/clusters_dataset/dist_2.csv ../dataset_3D/clusters_dataset/dist_3.csv 0.001 10000 ../html3Dviz/ 1 3
exit 0
