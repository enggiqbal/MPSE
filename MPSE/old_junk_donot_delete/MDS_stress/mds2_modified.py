...
X, stress, it=manifold.mds_3d_view(similarities,n_components=3, max_iter=400, eps=1e-9, random_state=seed,   verbose=3)
#print(X)
#pos=X
print(stress, it)

#mds = manifold.MDS3D(n_components=3, max_iter=300, eps=1e-9, random_state=seed,  dissimilarity="precomputed", n_jobs=1, verbose=3)
