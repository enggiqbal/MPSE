...
def main():
    ...
    y2 = np.genfromtxt(path+'male_1_2d.csv', delimiter = ',')
    x2 = plt.imread(data_path+'male_1.png')
    #y4 = np.genfromtxt(path+'face4_2d.csv', delimiter = ',')
    #x4 = plt.imread(data_path+'face4.png')
    y5 = np.genfromtxt(path+'male_2_2d.csv', delimiter = ',')
    x5 = plt.imread(data_path+'male_2.png')
    y6 = np.genfromtxt(path+'male_3_2d.csv', delimiter = ',')
    x6 = plt.imread(data_path+'male_3.png')
    y7 = np.genfromtxt(path+'male_4_2d.csv', delimiter = ',')
    x7 = plt.imread(data_path+'male_4.png')
