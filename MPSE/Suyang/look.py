...
def main():
    ...
    y2 = np.genfromtxt(path+'look1_2d.csv', delimiter = ',')
    x2 = plt.imread(data_path+'look1.png')
    #y4 = np.genfromtxt(path+'face4_2d.csv', delimiter = ',')
    #x4 = plt.imread(data_path+'face4.png')
    y5 = np.genfromtxt(path+'look2_2d.csv', delimiter = ',')
    x5 = plt.imread(data_path+'look2.png')
    y6 = np.genfromtxt(path+'look3_2d.csv', delimiter = ',')
    x6 = plt.imread(data_path+'look3.png')
    y7 = np.genfromtxt(path+'look4_2d.csv', delimiter = ',')
    x7 = plt.imread(data_path+'look4.png')
    y8 = np.genfromtxt(path+'look5_2d.csv', delimiter = ',')
    x8 = plt.imread(data_path+'look5.png')
